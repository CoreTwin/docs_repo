...
def update_content_system(docs_dir, content_json_path, description_md_path):
    ...
    if description_md_path:
        inject_back_to_toc_links(docs_dir, description_md_path, content_entries)
...
def inject_back_to_toc_links(docs_dir, description_md_path, content_entries, readme_path='README.md'):
...
def inject_back_to_toc_links_old(docs_dir, toc_md_path, toc):
...
def update_all(docs_dir, toc_path, toc_md_path=None):
    ...
    if toc_md_path:
        inject_back_to_toc_links_old(docs_dir, toc_md_path, toc)
